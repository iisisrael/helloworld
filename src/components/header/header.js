...
function Avatar(props) {
    return <img className="avatar mt-3" src={props.url} alt={props.text} />;
}
        ...
        <header>
            ...
            <Tabs defaultActiveKey="linkedin-tab" id="contact-tabs">
                ...
                <Tab
                    tabClassName="text-primary"
                    eventKey="phone-tab"
                    title={<FontAwesomeIcon icon={faMobile} />}
                >
                    <Contact url="tel:+15122340382" text="512.234.0382" />
                </Tab>
                <Tab
                    tabClassName="text-primary"
                    eventKey="address-tab"
                    title={<FontAwesomeIcon icon={faEnvelope} />}
                >
                    <Contact
                        url="https://goo.gl/maps/8W5WZ4xxofz9Js8L7"
                        texts={[
                            '1025 2nd St',
                            <br key="1" />,
    ...
    return (
        <div className="mugshot">
            <div>
                <Avatar
                    url={isBooks}
                    text="Stunning photo of Israel in front of his sci-fi book shelf."
                />
                <h1>
                    Israel J.
                    <br />
